//mport 'package:floating_chat_button/providers/home.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:project_coding_game/providers/home.dart';
...
class socketChatScreen extends StatefulWidget {
  ...
  const socketChatScreen({Key? key, required this.username}) : super(key: key);
  @override
...
class _socketChatScreenState extends State<socketChatScreen> {
  ...
  late String datareciver;

  _sendMessage() {
    _socket.emit( 'message',_messageInputController.value.text,);
