...
class UrlExecutor extends StatefulWidget {
  @override
  _UrlExecutorState createState() => _UrlExecutorState();
}

class _UrlExecutorState extends State<UrlExecutor> {
  final urlController = TextEditingController(text: "http://localhost:9095/ai/testQCM");
  String responseText = '';

  final urlController2 = TextEditingController(text: "http://localhost:9095/ai/saveQCM");
